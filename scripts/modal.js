function modal(){
    ...
    $(function() {
		...
		$('[data-popup-ok]').on('click', function(e)  {
            ...
            paramTag = example4.getTagValues();
    ...
    var modal = `
            <div class="popup" data-popup="popup-1">
                <div class="popup-inner">
                    ...
                    <p style="font-size: 15pt;">아는 단어 컨텐츠 설정</p>
                    <form name="titleform">
                        Title:<input type="text" style="" name="title" id="title" size="50" placeholder="콘텐츠 제목을 입력하세요.">
