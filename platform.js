...
(function() {
    ...
    var Q = function(a) {
        ...
        S = function(a, b, c) {
            if (b && "object" === typeof b)
                for (var d in b) !Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !mb(a[d]) && !mb(b[d]) ? S(a[d], b[d]) : b[d] && "object" ===
                typeof b[d] ? (a[d] = mb(b[d]) ? [] : {}, S(a[d], b[d])) : a[d] = b[d])
        },
        nb = function(a) {
            if (a && !/^\s+$/.test(a)) {
        ...
        pb = function(a) {
            ...
            (d[e].setAttribute("gapi_processed", !0), (f = d[e]) ? (g = f.nodeType, f = 3 == g || 4 == g ? f.nodeValue : f.textContent || f.innerText || f.innerHTML || "") : f = void 0, (f = nb(f)) && b.push(f));
            a && ob(c, a);
            d = Q("cd");
            a = 0;
            for (b = d.length; a < b; ++a) S(R(), d[a], !0);
            d = Q("ci");
            a = 0;
            for (b = d.length; a < b; ++a) S(R(), d[a], !0);
            a = 0;
            for (b = c.length; a < b; ++a) S(R(), c[a], !0)
        },
        T = function(a) {
            var b = R();
            if (!a) return b;
        ...
        vb = function() {
            if (!tb) {
                ...
                if (window.self !== window.top) {
                    ...
                    for (e in sb) 0 < sb[e] && (b = D(a, e, "")) && (ub[e] = b)
                }
                tb = !0
            }
            var e = v();
    ...
    var Eb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?\#]*)?\/u\/(\d)\//,
        ...
        Gb = function(a) {
            ...
            null == b && (a = a || window.location.href, b = D(a, "authuser") ||
                null, null == b && (b = (b = a.match(Eb)) ? b[1] : null));
    ...
    var Lb = m.crypto,
        ...
        Mb = !!Lb &&
            "function" == typeof Lb.getRandomValues;
    Mb || (Qb = 1E6 * (screen.width * screen.width + screen.height), Rb = Tb(p.cookie + "|" + p.location + "|" + (new Date).getTime() + "|" + Math.random()), Nb = T("random/maxObserveMousemove") || 0, 0 != Nb && H("mousemove", Sb, "add", "at"));
    var Ub = function() {
            var a = Pb,
    ...
    var Wb = function() {
        ...
        Xb = function(a, b) {
            b = b.onload;
            return "function" === typeof b ? (Wb().a(a, b), b) : null
        },
        Yb = function(a) {
    ...
    var $b = {
        ...
        dc = function(a, b, c, d, e) {
            ...
            for (var k in c) a = c[k], "style" === k && "object" === typeof a ? A(a, f.style) : ac[k] || f.setAttribute(k, String(a));
            ...
            if (void 0 !== a) {
                switch (typeof a) {
                    ...
                    case "object":
                        ...
                        for (b in a) !/___$/.test(b) && x(a, b) && "string" === typeof b && (d = kc(a[b])) && c.push(kc(b) + ":" + d);
                        return "{" + c.join(",") + "}"
                }
                return ""
            }
    ...
    var qc = function(a) {
        ...
        rc = function(a) {
            ...
            for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) {
                ...
                if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = qc(e)) && null != e.match(/^https?:\/\/[\w\-\_\.]+/i)) return e
            }
    ...
    var sc = {
        ...
        xc = function(a, b, c) {
            ...
            for (var g in sc) e[g] = g + "/" + (b[g] || sc[g]) + "/";
            e = ya(p, d.replace(fc,
                ic(e)));
            g = "iframes/" + a + "/params/";
            f = {};
            ...
            delete f.rd;
            for (var k in sc) f[k] && delete f[k];
            ...
            Bb(function(b) {
                if (a !== b.id && 4 != b.state && "share" != b.type) {
                    ...
                    if (f) {
                        var g = xc(d, b, 0);
                        g ? (f = f.parentNode,
                        e.replace(/\#.*/, "").replace(/(\?|&)ic=1/, "") !== g.replace(/\#.*/, "").replace(/(\?|&)ic=1/, "") && (b.dontclear = !0, b.rd = !0, b.ri = !0, b.type = d, Bc(f, b), (d = U[f.lastChild.id]) && (d.oid = c), Cb(c, 4))) : delete U[c]
                    } else delete U[c]
                }
            })
        };
    var W, X, Y, Dc, Ec, Fc = /(?:^|\s)g-((\S)*)(?:$|\s)/,
        Gc = {
            plusone: !0,
            autocomplete: !0,
            profile: !0,
        ...
        Hc = function(a, b, c, d) {
            ...
            for (f = 0; f < e.length; f++) {
                ...
                k.getAttribute("data-gapiscan") ? h = null : (0 == l.indexOf("g:") ?
                    n = l.substr(2) : (k = (k = String(k.className || k.getAttribute("class"))) && Fc.exec(k)) && (n = k[1]), h = !n || !(W[n] || X[n] || Y[n]) || h && n !== h ? null : n);
                h && (Gc[h] || 0 == g.nodeName.toLowerCase().indexOf("g:") || 0 != z(Ac(g)).length) && (g.setAttribute("data-gapiscan", !0), u(c, h, []).push(g))
            }
            if (b)
                for (var w in c)
                    for (b = c[w], d = 0; d < b.length; d++) b[d].setAttribute("data-onload", !0);
            for (var q in c) Dc.push(q);
            L("ps1", !0);
            if ((w = Dc.join(":")) || a) try {
                C.load(w, a)
            } catch (t) {
            ...
            if (Jc(Ec || {}))
                ...
                d = [];
                for (y in c)
                    for (a = c[y], q = 0, b = a.length; q < b; q++) e = a[q], Lc(y, e, Ac(e), d, b);
                Mc(w, d)
            }
        },
        Nc = function(a) {
    ...
    var Kc = function(a, b) {
            ...
            switch (Rc(b, a, f)) {
                ...
                case 1:
                    if (b.parentNode) {
                        ...
                        g.siteElement =
                            k;
                        k.id || (b = k, u(wc, a, 0), f = "___" + a + "_" + wc[a]++, b.id = f);
                        b = v();
                        b[">type"] = a;
                        A(c, b);
                        f = h;
                        ...
                        e = b = f;
                        ec.test(b) && (e = T("iframes/" + e.substring(1) + "/url"), B(!!e, "Unknown iframe url config for - " + b));
                        f = ya(p, e.replace(fc, hc));
                        b = c.ownerDocument || p;
                        k = 0;
                        do e = h.id || ["I", bc++, "_", (new Date).getTime()].join(""); while (b.getElementById(e) && 5 > ++k);
        ...
        Bc = function(a, b) {
            ...
            if (d) {
                ...
                Mc(c, e)
            } else yb("string" === "gapi." + c + ".render: missing element " + typeof a ? a : "")
        };
    u(C, "platform", {}).go = Ic;
    var Jc = function(a) {
    ...
    var Vc = /^\{h\:'/,
        ...
        Yc = function(a, b) {
            a = String(a);
            if (Vc.test(a)) return !0;
            var c = !1;
            Wc.test(a) && (c = !0, a = a.substr(2));
            if (!/^\{/.test(a)) return !1;
            var d = pc(a);
            if (!d) return !1;
            a = d.f;
            if (d.s && a && -1 != fa.call(b, a)) {
                if ("_renderstart" === d.s || d.s === Xc + "/" + a + "::_renderstart")
                    if (d = d.a && d.a[c ? 0 : 1], b = p.getElementById(a), Cb(a, 2), d && b && d.width && d.height) {
                        a: {
                            var c = b.parentNode,
                                e;a = d || {};
                            if (zb() && (e = b.id)) {
                            ...
                            var d = a.width,
                                ...
                                "none";g.cssFloat = "none";g.styleFloat = "none";g.lineHeight = "normal";g.fontSize = "1px";g.verticalAlign = "baseline";c = c.style;c.display = "inline-block";g = b.style;g.position = "static";g.left = "0";g.top = "0";g.visibility = "visible";d && (c.width = g.width = d + "px");f && (c.height = g.height = f + "px");a.verticalAlign && (c.verticalAlign = a.verticalAlign);e && Cb(e, 3)
                        }
    ...
    $c.prototype.write = function(a, b) {
        if (!bd.test(this.N)) throw "Invalid cookie name";
        if (!ad.test(a)) throw "Invalid cookie value";
        a = this.N + "=" + a;
    ...
    cd.iterate = function(a) {
        for (var b in dd) dd.hasOwnProperty(b) && a(b, dd[b])
    };
    ...
    Z.prototype.S = function() {
        this.D || (this.o = 0, this.D = !0, this.P())
    };
    Z.prototype.P = function() {
        this.D && (this.J() ? this.o = this.G : this.o = Math.min(2 * (this.o || this.G), 120), window.setTimeout(ca(this.P, this), 1E3 * this.o))
    };
            ...
            P("auth", {
                callback: function() {
                    ...
                    a.checkSessionState(e, function(b) {
                        ...
                        if (d = d != b) qb("isLoggedIn", b), Ab(), Cc(), b || ((b = a.signOut) ? b() : (b = a.setToken) && b(null));
                        b = vb();
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.ko.B1Qglq2E2Sk.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCOt4RcelYbYUmIpGerg8VZLpEWihQ",
